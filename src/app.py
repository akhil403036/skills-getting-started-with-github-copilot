...
activities = {
    ...
    # Two more sports-related activities
    "Soccer Team": {
    ...
    "Basketball Club": {
        "description": "Pickup games, drills, and team strategy sessions",
    ...
    # Two more intellectual activities
    "Debate Team": {
    ...
    "Math Club": {
        "description": "Problem solving, contest prep, and math projects",
